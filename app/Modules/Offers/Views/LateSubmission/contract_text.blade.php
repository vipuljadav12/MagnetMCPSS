...
@section('formstart')
    <form method="post" action="{{url('/LateSubmission/Offers/Contract/Fill/Store/'.$submission->offer_slug)}}" onsubmit="return validateForm()" id="contractform">
        {{csrf_field()}}
