<html lang="en">
  ...
  <body>
    ...
    <footer>
      <hr>
      <div class="text-center">{!! $contract_content->footer_text ?? '1 Magnum Pass Mobile, AL 36618 | Phone: 251-221-4000' !!}</div>
    </footer>
      ...
      <div class="wrapper">
        <div class="section section-1">
          <div class="container">
            <div class="">
              <div class="p-20">
                <div class="text-center font-20 b-600 mb-40">{{ $contract_content->title_text ?? 'MCPSS MAGNET SCHOOLS PARENT CONTRACT' }}</div>
                <div class="">
                  <div class="row">
                        ...
                        @foreach($conditions['options']['title'] as $key=>$title)
                          <div class="mb-10" style="text-align: justify;" >
                              ...
                              @if(isset($conditions['options']['content'][$key]) && $conditions['options']['content'][$key] != '')
                                <br>
                                <em class="font-14">
                                    {!! $conditions['options']['content'][$key] !!}
                                </em>
                              @endif
                          </div>
                        @endforeach
            ...
            <div class="" style="padding-top: 20px !important">
              ...
              <div class="mb-10">Parent Name - Printed : <strong>{{$submission->parent_first_name ." ".$submission->parent_last_name}}</strong>
              </div>
              <div class="mb-10">Student Name - Printed : <strong>{{$submission->first_name ." ".$submission->last_name}}</strong>
              </div>
            </div>
          </div>
        </div>
