        ...
        <div class="">
            <div class="p-20">
                ...
                <div class="">
                    ...
                    <span class="col-12 mb-10 text-lg-right">Date : <strong>{{$data['contract_signed_on']}}</strong></span></div>
