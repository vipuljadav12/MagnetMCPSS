...
<style type="text/css">
    ...
    <form class="">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item"><a class="nav-link " href="{{url('/admin/Process/Selection')}}">Processing</a></li>
            @if($from == "program")
                <li class="nav-item"><a class="nav-link" href="{{url('/admin/Process/Selection/Population/'.$pid)}}">Population Changes</a></li>
            @else
                <li class="nav-item"><a class="nav-link" href="{{url('/admin/Process/Selection/Population/Form/'.$pid)}}">Population Changes</a></li>
            @endif
