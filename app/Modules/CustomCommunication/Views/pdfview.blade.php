...
<body>
    ...
    <footer>
        {!! getconfig()['letter_footer'] ?? '1 Magnum Pass Mobile, AL 36618 | Phone: 251-221-4039' !!}
    </footer>
                        ...
                        <tr>
                            <td class="w-100">
                                <div class="logo-box"><img
                                        src="{{ isset($application_data) ? getDistrictLogo($application_data->display_logo) : getDistrictLogo() }}"
                                        title="" alt="" style="max-width: 100px !important;"></div>
                            </td>
                            <td class="w-100">
                                <div class="logo-box text-right"><img
                                        src="{{ url('/resources/assets/admin/images/login.png') }}" title=""
                                        alt="" style="max-width: 130px !important;"></div>
                            </td>
                        </tr>
                    </tbody>
                </table>
                    ...
                    <table class="table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="">Second Choice :
                                    {{ $value['second_choice'] != '' ? $value['second_choice'] : 'NA' }}</td>
                            </tr>
                            <tr>
                                <td class="">Student ID :
                                    {{ $value['student_id'] != '' ? $value['student_id'] : '' }}</td>
