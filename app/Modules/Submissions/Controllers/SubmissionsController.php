...
class SubmissionsController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        $online_flag = "last_date_online_acceptance";
        $offline_flag = "last_date_offline_acceptance";
        if($obj['finalObj'] == "waitlist")
        {
            ...
            $version = $obj['version'];
            $from = "Waitlist";
            $online_flag = "last_date_waitlist_online_acceptance";
            $offline_flag = "last_date_waitlist_offline_acceptance";
        ...
        elseif($obj['finalObj'] == "late_submission")
        {
            ...
            $version = $obj['version'];
            $from = "LateSubmission";
            $online_flag = "last_date_late_submission_online_acceptance";
            $offline_flag = "last_date_late_submission_offline_acceptance";
        ...
        if(!empty($offer_data))
        {
            ...
            {
                $rs = DistrictConfiguration::where("name", $online_flag)->where('enrollment_id', $submission->enrollment_id)->select("value")->first();
                if(!empty($rs))
                    $last_date_online_acceptance = $rs->value;

                $rs = DistrictConfiguration::where("name", $offline_flag)->where('enrollment_id', $submission->enrollment_id)->select("value")->first();
                if(!empty($rs))
                    $last_date_offline_acceptance = $rs->value;
