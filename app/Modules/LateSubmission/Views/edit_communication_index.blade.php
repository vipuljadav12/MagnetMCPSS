    ...
    @include("layouts.admin.common.alerts")
        ...
        <ul class="nav nav-tabs" id="myTab1" role="tablist">
            @foreach($statusArr as $key=>$value)
                ...
                @else
                    <li class="nav-item">
                        <a class="nav-link maintab" href="{{url('/admin/LateSubmission/EditCommunication/'.$key)}}">{{$value}}</a>
                    </li>
                @endif
            @endforeach
        </ul>
                            ...
                            <div class="tab-content tab-validate  bordered" id="myTab2Content">
                                ...
                                <div class="tab-pane fade show active" id="active-screen">
                                    ...
                                    <div class="form-group">
                                        <label style="width: 100%">Letter Body : @if(isset($data->letter_body) && $data->letter_body != '')<a href="{{url('/admin/LateSubmission/EditCommunication/preview/'.$status)}}" target="_blank" class="btn btn-success" style="float: right !important;">Preview</a>@endif</label>
                                ...
                                <div class="tab-pane fade @if($status == "ContractLetterText") show active @endif" id="active-email">
                                    ...
                                    <div class="form-group">
                                        <label style="width: 100%">Mail Subject : @if(isset($data->mail_subject) && $data->mail_body != '')<a href="{{url('/admin/LateSubmission/EditCommunication/preview/email/'.$status)}}" target="_blank" class="btn btn-success" style="float: right !important;">Preview</a>@endif</label>
                                        <div class="">
