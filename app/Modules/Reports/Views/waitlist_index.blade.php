...
.content-wrapper.active {z-index: 9999 !important}
    ...
    <div class="">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item"><a class="nav-link active" id="needs1-tab" data-toggle="tab" href="#needs1" role="tab" aria-controls="needs1" aria-selected="true">Waitlist Application Process Report</a></li>
            </ul>
                ...
                <div class="tab-pane fade show active" id="needs1" role="tabpanel" aria-labelledby="needs1-tab">
                    <ul class="nav nav-tabs" id="myTab1" role="tablist1">
                        @foreach($gradeTab as $value)
                            ...
                            @else
                                <li class="nav-item"><a class="nav-link" href="{{url('admin/Reports/waitlist/index/'.$value)}}">Grade {{$value}}</a></li>
                            @endif
                        @endforeach
                    </ul>
                                                    ...
                                                    <tr>
                                                        ...
                                                        @foreach($subjects as $sbjct)
                                                            @foreach($terms as $term)
                                                                <th class="align-middle grade-col text-center">{{$config_subjects[$sbjct]}} {{$term}}</th>
                                                            @endforeach
                                                        @endforeach
                                                            ...
                                                            @foreach($value['score'] as $skey=>$sbjct)
                                                                @foreach($terms as $term)
                                                                    <td class="grade-col text-center">
                                                                        @if(isset($sbjct[$term]))
                                                                            @if($sbjct[$term] != "")
                                                                                @if(isset($setEligibilityData[$value['first_choice']][$skey.'-'.$term]))
                                                                ...
                                                                @foreach($terms as $term)
                                                                    <td class="grade-col text-center">
                                                                        @if(isset($sbjct[$term]))
                                                                            ...
                                                                            @if(isset($setEligibilityData[$value['second_choice']][$skey.'-'.$term]))
