...
<script src="{{url('/resources/assets/admin')}}/js/bootstrap/dataTables.buttons.min.js"></script>
	...
	<script type="text/javascript">
        ...
        $.ajax({
            type: 'get',
            dataType: 'JSON',
            url: "{{url('admin/Reports/missing/'.$enrollment_id.'/cdi/response')}}",
...
//                        $('#datatable').DataTable().draw();
        ...
        function exportMissing()
        {
            if($("#filter_option").val() == "")
                document.location.href="{{url('/admin/Reports/export/missingcdi')}}/"+$("#enrollment").val();
            else
                document.location.href="{{url('/admin/Reports/export/missingcdi')}}/"+$("#enrollment").val()+"/"+$("#filter_option").val();
