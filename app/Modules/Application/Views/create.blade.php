    ...
    <div class="tab-content bordered" id="myTab2Content">
                ...
                <div class="row">
                                ...
                                <select class="form-control custom-select" name="enrollment_id" id="enrollment_id">
                                    <option value="0">Select Enrollment Year</option>
                                        @if(isset($enrollments))
                                            <option value="{{$enrollments->id}}">{{$enrollments->school_year}}</option>
                                        @endif
                                </select>
                            </div>
                    ...
                    <div class="col-12 col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="input-append date form_datetime">
                                <input class="form-control" name="cdi_starting_date" id="cdi_starting_date"  value="{{old('starting_date')}}" disabled="" {{-- readonly="readonly" --}}>
                    ...
                    <div class="col-12 col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="">
                                <input class="form-control" name="cdi_ending_date" id="cdi_ending_date" value="{{old('ending_date')}}" disabled="">
                            </div>
                            @if($errors->first('ending_date'))
                                <div class="mb-1 text-danger">
        ...
        <div class="tab-pane fade" id="active1-screen" role="tabpanel" aria-labelledby="active1-screen-tab">
            <div class="form-group">
                ...
                <div class="editor-height-210">
                    <input type="text" class="form-control" class="form-control" name="active_screen_title" value="{{$prev['active_screen_title']}}">
                </div>
            </div>
            <div class="form-group">
                <label>Active Screen Subject : </label>
                <div class="editor-height-210">
                    <input type="text" class="form-control" class="form-control" name="active_screen_subject" value="{{$prev['active_screen_subject']}}">
                </div>
            </div>
            <div class="form-group">
        ...
        <div class="tab-pane fade" id="active-email" role="tabpanel" aria-labelledby="active-email-tab">
            <div class="form-group">
                ...
                <div class="editor-height-210">
                    <input type="text" class="form-control" name="active_email_subject" class="form-control" name="active_email_subject" value="{{ $prev['active_email_subject'] }}">
                </div>
            </div>
            <div class="form-group">
        ...
        <div class="tab-pane fade" id="active2-email" role="tabpanel" aria-labelledby="active2-email-tab">
            <div class="form-group">
                <label>Email Subject : </label>
                <div class="editor-height-210">
                    <input type="text" class="form-control" name="active_email_subject" class="form-control" name="pending_email_subject" value="{{ $prev['active_email_subject'] }}">
                </div>
            </div>
            <div class="form-group">
