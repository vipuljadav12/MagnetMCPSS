<div class="tab-pane fade show active" id="preview03" role="tabpanel" aria-labelledby="preview03-tab">
    <form action="{{url('/admin/Waitlist/Availability/store')}}" method="post" id="process_selection">
             {{csrf_field()}}
    ...
    <div class="form-group mt-20">
        ...
        <div class=""><input class="form-control datetimepicker" name="last_date_waitlist_online_acceptance" id="last_date_waitlist_online_acceptance" value="{{$last_date_waitlist_online_acceptance}}" data-date-format="mm/dd/yyyy hh:ii"></div>
    </div>
    <div class="form-group">
        <label for="">Last day and time to accept OFFLINE</label>
        <div class=""><input class="form-control datetimepicker" name="last_date_waitlist_offline_acceptance" id="last_date_waitlist_offline_acceptance" value="{{$last_date_waitlist_offline_acceptance}}" data-date-format="mm/dd/yyyy hh:ii"></div>
    </div>
