...
<style type="text/css">
    ...
    <form class="">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item"><a class="nav-link " href="{{url('/admin/Waitlist/Availability/Show/'.$form_id)}}">All Programs</a></li>
            ...
            <li class="nav-item"><a class="nav-link" href="{{url('/admin/Waitlist/Submission/Result/'.$form_id)}}">Submission Result</a></li>
