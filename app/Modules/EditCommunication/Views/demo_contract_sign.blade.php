<html lang="en">
  ...
  <body>
    ...
    <footer>
      <hr>
          <div class="text-center">{!! strip_tags(getconfig()['letter_footer']) ?? '1 Magnum Pass Mobile, AL 36618 | Phone: 251-221-4039' !!}</div>
        </footer>
