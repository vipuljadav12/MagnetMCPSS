                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="input-append date form_datetime">
                                <input class="form-control" name="cdi_starting_date" id="cdi_starting_date" value="<?php echo e(($application->cdi_ending_date!='' ? date('m/d/Y', strtotime($application->cdi_starting_date)) : '')); ?>" disabled="" >
                    ...
                    <div class="col-12 col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="">
                                <input class="form-control" name="cdi_ending_date" id="cdi_ending_date" value="<?php echo e(($application->cdi_ending_date!='' ? date('m/d/Y', strtotime($application->cdi_ending_date)) : '')); ?>" disabled="">
                            </div>
                    ...
                    <div class="col-12 col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="">
                                <input class="form-control" disabled value="<?php echo e(url('/upload/'.$application->id.'/grade/cdi/')); ?>">
                            </div>
                        </div>
                    </div>
