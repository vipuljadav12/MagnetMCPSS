    ...
    <form action="<?php echo e(url('admin/Application/update', $application->id)); ?>" method="post" name="edit_application">
        ...
        <ul class="nav nav-tabs" id="myTab2" role="tablist">
            ...
            <li class="nav-item"><a class="nav-link" id="cdi-grade-upload-tab" data-toggle="tab" href="#cdi-grade-upload"
                    role="tab" aria-controls="cdi-grade-upload" aria-selected="false">Grade/CDI Upload Screen</a></li>
            <li class="nav-item"><a class="nav-link" id="cdi-grade-confirm-tab" data-toggle="tab" href="#cdi-grade-confirm"
                    role="tab" aria-controls="cdi-grade-confirm" aria-selected="false">Grade/CDI Upload - Confirmation
                    Screen</a></li>
        ...
        <div class="tab-content bordered" id="myTab2Content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="input-append date form_datetime">
                                    <input class="form-control" name="cdi_starting_date" id="cdi_starting_date"
                                        value="<?php echo e($application->cdi_ending_date != '' ? date('m/d/Y', strtotime($application->cdi_starting_date)) : ''); ?>"
                                        disabled="" >

                                </div>
                                <?php if($errors->first('cdi_starting_date')): ?>
                                    <div class="mb-1 text-danger">
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="">
                                    <input class="form-control" name="cdi_ending_date" id="cdi_ending_date"
                                        value="<?php echo e($application->cdi_ending_date != '' ? date('m/d/Y', strtotime($application->cdi_ending_date)) : ''); ?>"
                                        disabled="">
                                </div>
                                <?php if($errors->first('cdi_ending_date')): ?>
                                    <div class="mb-1 text-danger">
                            ...
                            <div class="form-group">
                                ...
                                <div class="">
                                    <input class="form-control" disabled
                                        value="<?php echo e(url('/upload/' . $application->id . '/grade/cdi/')); ?>">
                                </div>
                            </div>
                        </div>
                                    ...
                                    <?php $__empty_2 = true; $__currentLoopData = $program['grade_info']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$grade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                        <div class="">
                                            <div class="custom-control custom-checkbox custom-control-inline">
                                                <input type="checkbox" id="<?php echo e($program['id']); ?><?php echo e($grade['id']); ?>"
            ...
            <div class="tab-pane fade" id="active1-screen" role="tabpanel" aria-labelledby="active1-screen-tab">
                <div class="form-group">
                    <label style="width: 100%">Active Screen Title : <a
                            href="<?php echo e(url('/admin/Application/preview/active_screen/' . $application->id)); ?>"
                    ...
                    <div class="editor-height-210">
                        <input type="text" class="form-control" class="form-control" name="active_screen_title"
                            value="<?php echo !empty($application_configuration) ? $application_configuration->active_screen_title : ''; ?>">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="editor-height-210">
                        <input type="text" class="form-control" class="form-control" name="active_screen_subject"
                            value="<?php echo !empty($application_configuration) ? $application_configuration->active_screen_subject : ''; ?>">
                    </div>
                </div>
                <div class="form-group">
            ...
            <div class="tab-pane fade" id="active-email" role="tabpanel" aria-labelledby="active-email-tab">
                <div class="form-group">
                    <label style="width: 100%">Email Subject : <a
                            href="<?php echo e(url('/admin/Application/preview/active_email/' . $application->id)); ?>" target="_blank"
                            class="btn btn-success" style="float: right !important;">Preview</a></label>
                    <div class="editor-height-210">
                        <input type="text" class="form-control" name="active_email_subject" class="form-control"
                            name="active_email_subject"value="<?php echo !empty($application_configuration) ? $application_configuration->active_email_subject : ''; ?>">
                    </div>
                </div>
                <div class="form-group">
            ...
            <div class="tab-pane fade" id="active1-email" role="tabpanel" aria-labelledby="active1-email-tab">
                <div class="form-group">
                    <label style="width: 100%">Pending Screen Title : <a
                            href="<?php echo e(url('/admin/Application/preview/pending_screen/' . $application->id)); ?>"
                            target="_blank" class="btn btn-success" style="float: right !important;">Preview</a></label>
                    <div class="editor-height-210">
                        <input type="text" class="form-control" class="form-control" name="pending_screen_title"
                            value="<?php echo !empty($application_configuration) ? $application_configuration->pending_screen_title : ''; ?>">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="editor-height-210">
                        <input type="text" class="form-control" class="form-control" name="pending_screen_subject"
                            value="<?php echo !empty($application_configuration) ? $application_configuration->pending_screen_subject : ''; ?>">
                    </div>
                </div>
                <div class="form-group">
            ...
            <div class="tab-pane fade" id="active2-email" role="tabpanel" aria-labelledby="active2-email-tab">
                <div class="form-group">
                    <label style="width: 100%">Email Subject : <a
                            href="<?php echo e(url('/admin/Application/preview/pending_email/' . $application->id)); ?>"
                            target="_blank" class="btn btn-success" style="float: right !important;">Preview</a></label>

                    <div class="editor-height-210">
                        <input type="text" class="form-control" class="form-control" name="pending_email_subject"
                            value="<?php echo !empty($application_configuration) ? $application_configuration->pending_email_subject : ''; ?>">
                    </div>
                </div>
                <div class="form-group">
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\vipuljadav\www\projects\laravel\MagnetMCPSS\app/Modules/Application/Views/edit.blade.php ENDPATH**/ ?>