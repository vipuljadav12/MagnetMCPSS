...
<!--$(document).ready(function(){
	$(".theme-changer").on("change", function(){
        var cc = $(this).val();
        if(cc == "tcs") {
            $("body").attr("data-bg","theme02");
            $("header").attr("dataheader-bg","theme02");
            $(".logo-dark").children("img").attr("src","<?php echo e(url('/resources/assets/admin')); ?>/images/logo_light_tcs.png");
            $("#side-menu").children("li").show();
        }
        else if(cc == "magnet") {
            $("body").attr("data-bg","theme01");
            $("header").attr("dataheader-bg","theme01");
            $(".logo-dark").children("img").attr("src","<?php echo e(url('/resources/assets/admin')); ?>/images/logo_light_mcps.png");
            $("#side-menu").children("li").show();
            //$("#side-menu").children("li").hide();
            //$("#side-menu").children("li.master").show();
            //location.href = 'district-master.html';
        }
        else {
            $("body").attr("data-bg","theme01");
            $("header").attr("dataheader-bg","theme01");
            $(".logo-dark").children("img").attr("src","<?php echo e(url('/resources/assets/admin')); ?>/images/logo_light.png");
            $("#side-menu").children("li").show();
        }
    })
});  -->
...
</script><?php /**PATH D:\vipuljadav\www\projects\laravel\MagnetMCPSS\resources\views/layouts/admin/common/js.blade.php ENDPATH**/ ?>