                                            ...
                                            <select class="form-control custom-select" name="parent_submission_form">
                                                <option value="">Choose an Option</option>
                                                    <?php $__currentLoopData = $forms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="form<?php echo e($value->id); ?>" <?php if($program->parent_submission_form == $value->id): ?> selected="" <?php endif; ?>><?php echo e($value->name); ?></option>
                                        ...
                                        <div class="">
                                            <select class="form-control custom-select" name="magnet_school">
                                                ...
                                                <?php $__currentLoopData = $schools; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($value->current_school); ?>" <?php echo e($program->magnet_school==$value->current_school ? 'selected':''); ?>><?php echo e($value->current_school); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="col-12 col-lg-6">
                                 ...
                                 <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            <select class="form-control custom-sel2" name="feeder_priorities[]" multiple="">
                                                <option value="">Choose an Option</option>
                                                <?php $__currentLoopData = $schools; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if($value->current_school != ''): ?>
                                                        <option value="<?php echo e($value->current_school); ?>" <?php echo e(in_array($value->current_school, explode(',', $program->feeder_priorities)) ? 'selected':''); ?>><?php echo e($value->current_school); ?></option>
                                                    <?php endif; ?>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            <select class="form-control custom-sel2" name="magnet_priorities[]" multiple="">
                                                ...
                                                <?php $__currentLoopData = $schools; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if($value->current_school != ''): ?>
                                                        <option value="<?php echo e($value->current_school); ?>" <?php echo e(in_array($value->current_school, explode(',', $program->magnet_priorities)) ? 'selected':''); ?>><?php echo e($value->current_school); ?></option>
                                                    <?php endif; ?>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\vipuljadav\www\projects\laravel\MagnetMCPSS\app/Modules/Program/Views/edit.blade.php ENDPATH**/ ?>