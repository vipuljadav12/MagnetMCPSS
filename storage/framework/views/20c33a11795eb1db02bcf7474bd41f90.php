...
<script src="<?php echo e(url('/resources/assets/admin')); ?>/js/bootstrap/dataTables.buttons.min.js"></script>
	...
	<script type="text/javascript">
        ...
        $.ajax({
            type: 'get',
            dataType: 'JSON',
            url: "<?php echo e(url('admin/Reports/missing/'.$enrollment_id.'/allcdi/response')); ?>",
        ...
        function saveScore(id)
        {
            ...
            if (!$.isEmptyObject(data) && valid == true) { 
                ...
                $.ajax({
                    url : "<?php echo e(url('/admin/Reports/missing/cdi/save/')); ?>/"+id,
                    type: "POST",
                    data : data,
...
//                        $('#datatable').DataTable().draw();
        ...
        function exportMissing()
        {
            if($("#filter_option").val() == "")
                document.location.href="<?php echo e(url('/admin/Reports/export/allcdi')); ?>/"+$("#enrollment").val();
            else
                document.location.href="<?php echo e(url('/admin/Reports/export/allcdi')); ?>/"+$("#enrollment").val()+"/"+$("#filter_option").val();
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\vipuljadav\www\projects\laravel\MagnetMCPSS\app/Modules/Reports/Views/all_cdi.blade.php ENDPATH**/ ?>