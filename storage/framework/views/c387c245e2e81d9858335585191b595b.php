                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-6">
                                    ...
                                    <div class="form-group d-flex justify-content-between d-none" id="sibling_check">
                                        <label for="" class="control-label">Sibling Check : </label>
                                        ...
                                        <div class="">
                                            <select class="form-control custom-select" name="magnet_school">
                                                ...
                                                <?php $__currentLoopData = $schools; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($value->current_school); ?>"><?php echo e($value->current_school); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="col-12 col-lg-6">
                                 ...
                                 <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            <select class="form-control custom-select" multiple="" name="feeder_priorities[]">
                                                <option value="">Choose an Option</option>
                                                <?php $__currentLoopData = $schools; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            <select class="form-control custom-select" multiple="" name="magnet_priorities[]">
                                                <option value="">Choose an Option</option>
                                                <?php $__currentLoopData = $schools; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if($value->current_school != ''): ?>
                                                        <option value="<?php echo e($value->current_school); ?>"><?php echo e($value->current_school); ?></option>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\vipuljadav\www\projects\laravel\MagnetMCPSS\app/Modules/Program/Views/create.blade.php ENDPATH**/ ?>