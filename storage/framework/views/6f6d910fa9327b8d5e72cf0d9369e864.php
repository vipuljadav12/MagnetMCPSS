...
<div class="card shadow">
    <div class="card-body d-flex align-items-center justify-content-between flex-wrap">
        <div class="page-title mt-5 mb-5">Late Submission Edit Communication</div>
    </div>
</div>
    <?php echo $__env->make("layouts.admin.common.alerts", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <ul class="nav nav-tabs" id="myTab1" role="tablist">
            <?php $__currentLoopData = $statusArr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php else: ?>
                    <li class="nav-item">
                        <a class="nav-link maintab" href="<?php echo e(url('/admin/LateSubmission/EditCommunication/'.$key)); ?>"><?php echo e($value); ?></a>
                    </li>
                <?php endif; ?>
                ...
                <ul class="nav nav-tabs custom-nav-tabs" id="myTab2">
                            ...
                            <div class="tab-content tab-validate  bordered" id="myTab2Content">
                                ...
                                <div class="tab-pane fade show active" id="active-screen">
                                     <form class="" action="<?php echo e(url('admin/LateSubmission/EditCommunication/store/letter')); ?>" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label style="width: 100%">Letter Body : <?php if(isset($data->letter_body) && $data->letter_body != ''): ?><a href="<?php echo e(url('/admin/LateSubmission/EditCommunication/preview/'.$status)); ?>" target="_blank" class="btn btn-success" style="float: right !important;">Preview</a><?php endif; ?></label>
                                ...
                                <div class="tab-pane fade <?php if($status == "ContractLetterText"): ?> show active <?php endif; ?>" id="active-email">
                                    <form class="" action="<?php echo e(url('admin/LateSubmission/EditCommunication/store/email')); ?>" method="POST">
                                    <?php echo e(csrf_field()); ?>
                                    ...
                                    <div class="form-group">
                                        <label style="width: 100%">Mail Subject : <?php if(isset($data->mail_subject) && $data->mail_body != ''): ?><a href="<?php echo e(url('/admin/LateSubmission/EditCommunication/preview/email/'.$status)); ?>" target="_blank" class="btn btn-success" style="float: right !important;">Preview</a><?php endif; ?></label>
                                        <div class="">
                                    ...
                                    <div class="form-group"> <input type="submit" class="btn btn-secondary" value="Save Changes"> <?php if($display_outcome > 0): ?> <?php if($status != "ContractLetterText"): ?><a href="javascript:void(0)" class="btn btn-success" onclick="fetchEmails()" id="generate_email_link">Confirm Emails</a>  <input type="submit" name="send_email_now" value="Send Emails Now" class="btn btn-success d-none" id="generate_email_submit"><?php endif; ?> <?php endif; ?></div>
                                    </form>
                                    
                                </div>
                                <?php if($status != "ContractLetterText"): ?>
                                    <div class="tab-pane fade" id="screen-log">
                                        <?php echo $__env->make("LateSubmission::letter_log", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                    </div>
                                    <div class="tab-pane fade" id="email-log">
                                        <?php echo $__env->make("LateSubmission::email_log", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                    </div>
                                <?php endif; ?>
                            </div>
            </div>
        ...
        function fetchEmails()
        {
            if($("#mail_body").val() != "" && $("#mail_subjet").val() != "")
            {
                ...
                var status = "<?php echo e($dbStatusArr[$status]); ?>";
                 ...
                 $.ajax({
                    url:'<?php echo e(url('/admin/LateSubmission/EditCommunication/get/emails/')); ?>',
                    type:"post",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\vipuljadav\www\projects\laravel\MagnetMCPSS\app/Modules/LateSubmission/Views/edit_communication_index.blade.php ENDPATH**/ ?>